...
import { Settings, X, User, Globe, Mail, MapPin, Building, Calendar, Save, Edit3 } from "lucide-react";
...
{t("settings.edit")}
              ...
              <TabsContent value="appearance" className="space-y-3">
                <Card className="bg-card border-border">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-foreground text-sm">{t("settings.language")}</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div>
