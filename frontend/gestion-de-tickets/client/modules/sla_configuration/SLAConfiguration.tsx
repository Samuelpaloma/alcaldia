...
export default function SLAConfiguration() {
  ...
  const actualizarConfiguracionSLA = async () => {
    ...
    try {
      ...
      console.error('Error al actualizar configuración SLA:', error);
      alert('❌ Error al actualizar configuración SLA: ' + (error as Error).message);
    }
  };
  ...
  const eliminarConfiguracionSLA = async (id: number) => {
    ...
    try {
      ...
      console.error('Error al eliminar configuración SLA:', error);
      alert('❌ Error al eliminar configuración SLA: ' + (error as Error).message);
    }
  };
  ...
  const getPriorityBadge = (priority: string) => {
    const priorityConfig = {
      ...
      'ALTA': { color: 'bg-orange-100 text-orange-800 border-orange-200', icon: ArrowUp, label: 'ALTA' },
      'MEDIA': { color: 'bg-yellow-100 text-yellow-800 border-yellow-200', icon: Clock, label: 'MEDIA' },
      'BAJA': { color: 'bg-green-100 text-green-800 border-green-200', icon: ArrowDown, label: 'BAJA' }
    };
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={formularioSLA.prioridad} onValueChange={(value) => setFormularioSLA({ ...formularioSLA, prioridad: value })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormularioSLA({ ...formularioSLA, activo: checked })}
                />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormularioSLA({ ...formularioSLA, activo: checked })}
                />
                <Label htmlFor="activo-edit">Configuración activa</Label>
              </div>
            </div>
