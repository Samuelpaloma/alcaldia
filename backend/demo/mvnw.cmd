...
@REM check for pre script, once with legacy .bat extension and once with current
...
@REM check for post script, once with legacy .bat extension and once with current
